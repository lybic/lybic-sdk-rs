...
pub trait ProjectApi: Send + Sync {
    async fn create_project(
        &self,
        org_id: &str,
        create_project_dto: Option<crate::models::CreateProjectDto>,
    ) -> Result<crate::models::SingleProjectResponseDto, Error<serde_json::Value>>;
...
impl<C: Connect + Clone + Send + Sync + 'static> ProjectApi for ProjectApiClient<C> {
    async fn create_project(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/orgs/{orgId}/projects".to_string(),
        );
    ...
    async fn delete_project(
        ...
        let mut req = __internal_request::Request::new(
            Method::DELETE,
            "/api/orgs/{orgId}/projects/{projectId}".to_string(),
        );
    ...
    async fn list_projects(
        ...
        let mut req =
            __internal_request::Request::new(Method::GET, "/api/orgs/{orgId}/projects".to_string());
        req = req.with_path_param("orgId".to_string(), org_id.to_string());
