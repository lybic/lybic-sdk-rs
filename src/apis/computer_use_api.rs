...
impl<C: Connect> ComputerUseApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> ComputerUseApiClient<C> {
        ComputerUseApiClient { configuration }
    }
}
...
pub trait ComputerUseApi: Send + Sync {
    async fn parse_model_output(
        &self,
        computer_use_parse_request_dto: Option<crate::models::ComputerUseParseRequestDto>,
    ) -> Result<crate::models::ComputerUseActionResponseDto, Error<serde_json::Value>>;
    async fn parse_model_text_output(
        &self,
        _type: &str,
        computer_use_parse_text_request_dto: Option<crate::models::ComputerUseParseTextRequestDto>,
    ) -> Result<crate::models::ComputerUseActionResponseDto, Error<serde_json::Value>>;
    async fn parse_model_text_output_0(
        &self,
        _type: &str,
        computer_use_parse_text_request_dto: Option<crate::models::ComputerUseParseTextRequestDto>,
    ) -> Result<crate::models::ComputerUseActionResponseDto, Error<serde_json::Value>>;
...
impl<C: Connect + Clone + Send + Sync + 'static> ComputerUseApi for ComputerUseApiClient<C> {
    async fn parse_model_output(
        ...
        let mut req =
            __internal_request::Request::new(Method::POST, "/api/computer-use/parse".to_string());
    ...
    async fn parse_model_text_output(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/computer-use/parse/{type}".to_string(),
        );
