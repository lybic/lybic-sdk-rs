...
impl<C: Connect> SandboxApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> SandboxApiClient<C> {
        SandboxApiClient { configuration }
    }
}
...
pub trait SandboxApi: Send + Sync {
    async fn create_sandbox(
        &self,
        org_id: &str,
        create_sandbox_dto: Option<crate::models::CreateSandboxDto>,
    ) -> Result<crate::models::GetSandboxResponseDto, Error<serde_json::Value>>;
    ...
    async fn execute_computer_use_action(
        ...
        sandbox_id: &str,
        org_id: &str,
        computer_use_action_dto: Option<crate::models::ComputerUseActionDto>,
    ) -> Result<crate::models::SandboxActionResponseDto, Error<serde_json::Value>>;
    async fn extend_sandbox(
        &self,
        sandbox_id: &str,
        org_id: &str,
        extend_sandbox_dto: Option<crate::models::ExtendSandboxDto>,
    ) -> Result<serde_json::Value, Error<serde_json::Value>>;
    async fn extend_sandbox_0(
        &self,
        sandbox_id: &str,
        org_id: &str,
        extend_sandbox_dto: Option<crate::models::ExtendSandboxDto>,
...
impl<C: Connect + Clone + Send + Sync + 'static> SandboxApi for SandboxApiClient<C> {
    async fn create_sandbox(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/orgs/{orgId}/sandboxes".to_string(),
        );
    ...
    async fn delete_sandbox(
        ...
        let mut req = __internal_request::Request::new(
            Method::DELETE,
            "/api/orgs/{orgId}/sandboxes/{sandboxId}".to_string(),
        );
    ...
    async fn execute_computer_use_action(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/orgs/{orgId}/sandboxes/{sandboxId}/actions/computer-use".to_string(),
        );
        req = req.with_path_param("sandboxId".to_string(), sandbox_id.to_string());
        req = req.with_path_param("orgId".to_string(), org_id.to_string());
    ...
    async fn extend_sandbox(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/orgs/{orgId}/sandboxes/{sandboxId}/extend".to_string(),
        );
        req = req.with_path_param("sandboxId".to_string(), sandbox_id.to_string());
        req = req.with_path_param("orgId".to_string(), org_id.to_string());
    ...
    async fn preview_sandbox(
        ...
        let mut req = __internal_request::Request::new(
            Method::POST,
            "/api/orgs/{orgId}/sandboxes/{sandboxId}/preview".to_string(),
        );
        req = req.with_path_param("sandboxId".to_string(), sandbox_id.to_string());
        req = req.with_path_param("orgId".to_string(), org_id.to_string());
